/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 92b74e97e916be369a26910157220b39)
// Runtime types generated with workerd@1.20260825.1 2026-08-25 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AUTH_WRAP_KEY: "oc-local-wrap";
	VAULT: DurableObjectNamespace<import("./src/server").UserVault>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "UserVault";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_WRAP_KEY">> {}
}
