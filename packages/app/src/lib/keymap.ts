...
export const paneConfig: Record<Pane, PaneConfig> = {
  ...
  login: {
    ...
    bindings: [
      ...
      { id: 'expand', hotkey: 'Enter', label: 'edit', flag: 'canEdit' },
      {
        id: 'send',
        hotkey: 'Mod+Enter',
        label: 'sign in',
      ...
      { id: 'createAccount', hotkey: 'C', label: 'create account', flag: 'signIn' },
      { id: 'useAccount', hotkey: 'S', label: 'sign in', flag: 'signUp' },
